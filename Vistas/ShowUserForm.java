...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    public void ActualizarEmpleado() {
        ...
        String queryIdEmpleado = "SELECT idEmp, FK_idPuestoTrabajo from empleados inner join puestoTrabajo ON(puestoTrabajo.idPuestoTrabajo = empleados.FK_idPuestoTrabajo) where documento = '" + documento + "';";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (nombre.isEmpty()) {
                    ...
                    String query = "UPDATE `empleados` SET `nombres`='" + nombre + "',`apellidos`='" + apellidos + "',`correo`='" + correo
    ...
    public void EliminarEmpleado() {
        ...
        try {
            ...
            while (rs.next()) {
                int idEmpleado = rs.getInt("idEmp");
                String queryEliminar = "DELETE FROM empleados WHERE documento = '" + documento + "'";
                try {
